...
.product .btn:hover {
      ...
      <?php
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<a href="checkout.php?product_id=' . $row['id'] . '&product_name=' . urlencode($row['name']) . '&product_price=' . $row['price'] . '" class="btn-buy">Buy</a>';
                echo '</div>';
            }
        } else {
            ...
            <form method="POST" action="db_connect.php" enctype="multipart/form-data">
              ...
              <div class="col-12">
                  <div class="form-floating">
                      ...
                      <label for="image">Upload Image Perscription</label>
                  </div>
              </div>
  ...
  <section class="container-fluid footer_section">
    <p>
     Developed by: Rigers Poleshi, Klea Murat, Shendi Stana, Livia Hazizaj
    </p>
  </section>
  <!-- footer section -->
